...
cd create-dmg
./create-dmg --volname "NXEngine" --window-size 640 480 --app-drop-link 380 205 --background ../platform/osx/bg.png --icon-size 96 --icon "NXEngine.app" 110 205 "../NXEngine-$APPVEYOR_REPO_TAG_NAME.dmg" ../release/
